        ...
        >
            ...
            <ThemedView style={styles.section}>
                ...
                <SettingItem
                    ...
                    onPress={() => router.push('/(manager)/profile/settings/notifications' as any)}
                />
                <SettingItem
                    icon="lock.shield"
                    label="Privacy Settings"
                    onPress={() => router.push('/(manager)/profile/settings/privacy' as any)}
                />
                <SettingItem
                    icon="lock"
                    label="Change Password"
                    onPress={() => router.push('/(manager)/profile/settings/change-password' as any)}
                />
                <SettingItem
                    icon="questionmark.circle"
                    label="Customer Support"
                    onPress={() => router.push('/(manager)/profile/support' as any)}
                />
            </ThemedView>
