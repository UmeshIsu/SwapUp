    ...
    return (
        ...
        >
            ...
            <Tabs.Screen
                ...
                options={{
                    title: 'My Schedule',
                    tabBarIcon: ({ focused, color }) => <TabBarIcon focused={focused} color={color} name="calendar.fill" />,
                }}
            />
            <Tabs.Screen
                name="profile"
            ...
            <Tabs.Screen
                ...
                options={{
                    title: 'Reports',
                    tabBarIcon: ({ focused, color }) => <TabBarIcon focused={focused} color={color} name="chart.bar.fill" />,
                }}
            />
        </Tabs>
    );
