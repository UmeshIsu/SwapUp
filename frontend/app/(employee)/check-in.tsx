    ...
    const handleCheckIn = async () => {
        try {
            ...
            if (result.status === 'APPROVED') {
                ...
                setDistanceM(result.distanceM ?? 0);
                setState('approved');
            } else {
                setRejectReason(result.reason ?? 'Check-in was rejected.');
                setState('rejected');
            }
        } catch (err: any) {
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.body}>
                ...
                <Text style={styles.subtitle}>
                    Your location will be captured and verified against the site. Make sure you are
                    on-site and have good GPS signal.
                </Text>

                <View style={styles.infoCardRow}>
                    <InfoCard icon="locate" label="GPS Required" value="High accuracy" />
                    <InfoCard icon="navigate-circle" label="Max Distance" value="150 m" />
