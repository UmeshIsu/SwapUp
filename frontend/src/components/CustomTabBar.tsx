...
const TAB_ICONS: Record<string, { light: any; dark: any }> = {
    // ── Employee tabs ──────────────────────────────────────────────────────────
    'index': { light: require('@/assets/images/ETaskBar/HomeLight.png'), dark: require('@/assets/images/ETaskBar/HomeDark.png') },
    ...
    return (
        <View style={[styles.container, { paddingBottom: Math.max(insets.bottom, 8) }]}>
            {state.routes.map((route, index) => {
                ...
                // Expo Router uses href: null to hide screens from the tab bar.
                if (options?.href === null || icons == null) {
                    return null;
                }
